...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var CuzEscape = (function () {
      function CuzEscape() {

      };
      CuzEscape.value = new CuzEscape();
      return CuzEscape;
  })();
  var CuzBlur = (function () {
      function CuzBlur() {

      };
      CuzBlur.value = new CuzBlur();
      return CuzBlur;
  })();
  var CuzNoMatches = (function () {
      function CuzNoMatches() {

      };
      CuzNoMatches.value = new CuzNoMatches();
      return CuzNoMatches;
  })();
  var CuzSelect = (function () {
      function CuzSelect() {

      };
      CuzSelect.value = new CuzSelect();
      return CuzSelect;
  })();
  var Init = (function () {
  ...
  var UpdateItems = (function () {
      function UpdateItems(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateItems.create = function (value0) {
          return function (value1) {
              return new UpdateItems(value0, value1);
          };
      };
      return UpdateItems;
  })();
  ...
  var ItemClick = (function () {
      function ItemClick(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ItemClick.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ItemClick(value0, value1, value2);
              };
          };
      };
      return ItemClick;
  ...
  var Previous = (function () {
      function Previous(value0) {
          this.value0 = value0;
      };
      Previous.create = function (value0) {
          return new Previous(value0);
      };
      return Previous;
  })();
  var Next = (function () {
  ...
  var KeyDown = (function () {
      function KeyDown(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      KeyDown.create = function (value0) {
          return function (value1) {
              return new KeyDown(value0, value1);
          };
      };
      return KeyDown;
  })();
  ...
  var ulRef = "autocomplete-ul";
  var scrollListToIndex = function (dictMonadEff) {
      return function (index) {
          return function (el) {
              return Control_Monad_Eff_Class.liftEff(dictMonadEff)(function __do() {
                  var v = DOM_Node_Node.childNodes(DOM_HTML_Types.htmlElementToNode(el))();
                  return Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_Node_NodeList.item(index)(v))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(function (item) {
                      var itemElement = Unsafe_Coerce.unsafeCoerce(item);
                      return function __do() {
                          var v1 = DOM_HTML_HTMLElement.offsetTop(itemElement)();
                          var v2 = DOM_Node_Element.clientHeight(DOM_HTML_Types.htmlElementToElement(el))();
                          var v3 = DOM_Node_Element.clientHeight(DOM_HTML_Types.htmlElementToElement(itemElement))();
                          return DOM_Node_Element.setScrollTop((v1 - v2) + v3)(DOM_HTML_Types.htmlElementToElement(el))();
                      };
                  }))();
              });
          };
  ...
  var $$goto = function (dictMonadEff) {
      return function (itemText) {
          return function (index) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $35.index = new Data_Maybe.Just(index);
                  $35.statusText = Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(itemText)(Data_Array.index(state.items)(index)));
                  return $35;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ulRef))(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(scrollListToIndex(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(index)));
              });
          };
      };
  };
  var defaultConfig = {
      containerClass: "halogen-autocomplete", 
      itemFilter: function (input) {
          return function (item) {
              return Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_String["null"])(input) && Data_String.contains(input)(item);
          };
      }, 
      itemText: Control_Category.id(Control_Category.categoryFn), 
      itemDisplay: function (item) {
          return Halogen_HTML_Core.text(item);
      }
  };
  var close = function (reason) {
      return Control_Monad.whenM(Halogen_Query_HalogenM.monadHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          return v.open;
      }))(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          var $38 = {};
          for (var $39 in v) {
          ...
          $38.index = Data_Maybe.Nothing.value;
          $38.open = false;
          return $38;
      }));
  };
  var className = function ($103) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($103));
  };
  var component = function (dictMonadEff) {
      return function (v) {
          var render = function (state) {
              var mkSelection = function (ix) {
                  return function (item) {
                      return Halogen_HTML_Elements.li([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input(ItemClick.create(item))), Halogen_HTML_Properties_ARIA.selected((function () {
                          var $42 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(ix))(state.index);
                          if ($42) {
                              return "true";
                          };
                          return "false";
                      })()) ])([ Data_Bifunctor.bimap(Halogen_HTML_Core.bifunctorHTML)(Data_Void.absurd)(function ($104) {
                          return Data_Void.absurd(Data_Newtype.un(Data_Const.newtypeConst)(Data_Const.Const)($104));
                      })(v.itemDisplay(item)) ]);
                  };
              };
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(v.containerClass) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state.inputText), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Input.create)), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Blur.create)), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(KeyDown.create)) ]), Halogen_HTML_Elements.ul(Control_Bind.join(Control_Bind.bindArray)([ Data_Functor.voidLeft(Data_Functor.functorArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(!state.open))(Halogen_HTML_Properties_ARIA.hidden("")), Data_Functor.voidLeft(Data_Functor.functorArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(!state.open))(Halogen_HTML_Properties.class_("hidden")), Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Properties.ref(ulRef)) ]))(Data_Array.mapWithIndex(mkSelection)(Data_Array.filter(v.itemFilter(state.inputText))(state.items))), Halogen_HTML_Elements.span([ className("visually-hidden"), Halogen_HTML_Properties_ARIA.role("status"), Halogen_HTML_Properties_ARIA.live("assertive"), Halogen_HTML_Properties_ARIA.relevant("additions") ])([ Halogen_HTML_Core.text(state.statusText) ]) ]);
          };
          ...
          var displayedItems = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Array.filter(v.itemFilter(v1.inputText))(v1.items));
          });
          var $$eval = function (v1) {
              if (v1 instanceof Init) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
              };
              if (v1 instanceof UpdateItems) {
              ...
              if (v1 instanceof Input) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Changed(v1.value0)))(function () {
                              var $57 = Data_Array["null"](Data_Array.filter(v.itemFilter(v1.value0))(v2.items));
                              if ($57) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(CuzNoMatches.value))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                                  });
                              };
                              return $$eval(new Open(v1.value1));
                          });
                      });
                  });
              };
              if (v1 instanceof Blur) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(CuzBlur.value))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                  });
              };
              if (v1 instanceof ItemClick) {
                  var v2 = DOM_Event_MouseEvent.button(v1.value1);
                  if (v2 === 0) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.mouseEventToEvent(v1.value1))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(CuzSelect.value))(function () {
                              return $$eval(new Select(v1.value0, v1.value2));
                          });
                      });
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value2);
              };
              if (v1 instanceof Select) {
                  var newInput = v.itemText(v1.value0);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $66 = {};
                      for (var $67 in v2) {
                      ...
                      $66.inputText = newInput;
                      return $66;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Changed(newInput)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Selected(v1.value0)))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                          });
                      });
                  });
              };
              if (v1 instanceof Previous) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      if (v2.index instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                      };
                      if (v2.index instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Array.length)(displayedItems))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$goto(dictMonadEff)(v.itemText)((function () {
                                  var $74 = v2.index.value0 === 0;
                                  if ($74) {
                                      return v3 - 1 | 0;
                                  };
                                  return v2.index.value0 - 1 | 0;
                              })()))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 174, column 8 - line 179, column 18: " + [ v2.index.constructor.name ]);
                  });
              };
              if (v1 instanceof Next) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 182, column 8 - line 187, column 18: " + [ v2.index.constructor.name ]);
                  });
              };
              if (v1 instanceof Open) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $85.open = true;
                      $85.index = new Data_Maybe.Just(0);
                      return $85;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                  });
              };
              if (v1 instanceof Close) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(v1.value0))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                  });
              };
              if (v1 instanceof KeyDown) {
                  var v2 = DOM_Event_KeyboardEvent.code(v1.value0);
                  if (v2 === "Enter") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v1.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(displayedItems)(function (v4) {
                                  var v5 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function (v6) {
                                      return Data_Array.index(v4)(v6);
                                  })(v3.index);
                                  if (v5 instanceof Data_Maybe.Just) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(CuzSelect.value))(function () {
                                          return $$eval(new Select(v5.value0, v1.value1));
                                      });
                                  };
                                  if (v5 instanceof Data_Maybe.Nothing) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                                  };
                                  throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 200, column 12 - line 204, column 30: " + [ v5.constructor.name ]);
                              });
                          });
                      });
                  };
                  if (v2 === "Escape") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(close(CuzEscape.value))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                      });
                  };
                  if (v2 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v1.value0))))(function () {
                          return $$eval(new Previous(v1.value1));
                      });
                  };
                  if (v2 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v1.value0))))(function () {
                          return $$eval(new Next(v1.value1));
                      });
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
              };
              throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 142, column 12 - line 214, column 20: " + [ v1.constructor.name ]);
          };
          return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
              ...
              receiver: Halogen_HTML_Events.input(UpdateItems.create)
          });
      };
  };
  ...
  exports["Close"] = Close;
  exports["KeyDown"] = KeyDown;
  exports["CuzEscape"] = CuzEscape;
  exports["CuzBlur"] = CuzBlur;
  exports["CuzNoMatches"] = CuzNoMatches;
  exports["CuzSelect"] = CuzSelect;
  exports["className"] = className;
  exports["close"] = close;
  exports["component"] = component;
  exports["defaultConfig"] = defaultConfig;
  exports["scrollListToIndex"] = scrollListToIndex;
  exports["ulRef"] = ulRef;
})(PS["Halogen.Autocomplete.Component"] = PS["Halogen.Autocomplete.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Halogen_Autocomplete_Component = PS["Halogen.Autocomplete.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = PS["Halogen.HTML.Elements"];
  ...
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];        
  var customElemConf = (function () {
      var $26 = {};
      for (var $27 in Halogen_Autocomplete_Component.defaultConfig) {
          if ({}.hasOwnProperty.call(Halogen_Autocomplete_Component.defaultConfig, $27)) {
              $26[$27] = Halogen_Autocomplete_Component["defaultConfig"][$27];
          };
      };
      $26.itemText = function (v1) {
          return v1.name;
      };
      $26.itemDisplay = function (v1) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(v1.name), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("Age: " + Data_Show.show(Data_Show.showInt)(v1.age)) ]) ]);
      };
      $26.itemFilter = function (input) {
          return function (v1) {
              return Data_String.contains(input)(v1.name);
          };
      };
      return $26;
  })();
  var conf = Halogen_Autocomplete_Component.defaultConfig;
  var ciConf = (function () {
      var $29 = {};
      for (var $30 in Halogen_Autocomplete_Component.defaultConfig) {
          if ({}.hasOwnProperty.call(Halogen_Autocomplete_Component.defaultConfig, $30)) {
              $29[$30] = Halogen_Autocomplete_Component["defaultConfig"][$30];
          };
      };
      $29.itemFilter = function (input) {
          return function (item) {
              return Data_String.contains(Data_String.toLower(input))(Data_String.toLower(item));
          };
      };
      return $29;
  })();
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement("#simpleExample"))(function (v1) {
          var __unused = function (dictPartial1) {
              return function ($dollar16) {
                  return $dollar16;
              };
          ...
          return __unused()((function () {
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement("#caseInsensitive"))(function (v2) {
                      var __unused = function (dictPartial1) {
                      ...
                      return __unused()((function () {
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.selectElement("#customElement"))(function (v3) {
                                  var __unused = function (dictPartial1) {
                                  ...
                                  return __unused()((function () {
                                      if (v3 instanceof Data_Maybe.Just) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Halogen_Autocomplete_Component.component(Control_Monad_Aff.monadEffAff)(conf))([ "Hello", "Wello", "Yellow", "Darkness", "My old friend" ])(v1.value0))(function (v4) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Halogen_Autocomplete_Component.component(Control_Monad_Aff.monadEffAff)(ciConf))([ "CARL", "carl", "CaRl", "Darkness", "My old friend" ])(v2.value0))(function (v5) {
                                                  return Halogen_VDom_Driver.runUI(Halogen_Autocomplete_Component.component(Control_Monad_Aff.monadEffAff)(customElemConf))([ {
                                                      name: "Carl", 
                                                      age: 25
                                                  }, {
                                                      name: "Peter", 
                                      ...
                                      throw new Error("Failed pattern match at Main line 37, column 3 - line 37, column 76: " + [ v3.constructor.name ]);
                                  })());
                              });
                          };
                          throw new Error("Failed pattern match at Main line 36, column 3 - line 36, column 80: " + [ v2.constructor.name ]);
                      })());
                  });
              };
              throw new Error("Failed pattern match at Main line 35, column 3 - line 35, column 69: " + [ v1.constructor.name ]);
          })());
      });
  }));
  exports["ciConf"] = ciConf;
  exports["conf"] = conf;
  exports["customElemConf"] = customElemConf;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
