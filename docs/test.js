...
(function(exports) {
  ...
  var showReason = function (v) {
      ...
      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 49, column 14 - line 55, column 1: " + [ v.constructor.name ]);
  };
  ...
  var className = function ($98) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($98));
  };
              ...
              var mkSelection = function (ix) {
                  return function (item) {
                      return Halogen_HTML_Elements.li([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input(ItemClick.create(item))), Halogen_HTML_Properties_ARIA.selected((function () {
                          ...
                          return "false";
                      })()) ])([ Halogen_HTML_Core.text(v.itemText(item)) ]);
                  };
              };
          ...
          var $$eval = function (v1) {
              ...
              if (v1 instanceof Previous) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 162, column 8 - line 167, column 18: " + [ v2.index.constructor.name ]);
                  });
              };
              if (v1 instanceof Next) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 170, column 8 - line 175, column 18: " + [ v2.index.constructor.name ]);
                  });
              };
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v1.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(displayedItems)(function (v4) {
                                  ...
                                  throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 188, column 12 - line 190, column 30: " + [ v5.constructor.name ]);
                              });
                          });
                      });
                  };
              ...
              throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 138, column 12 - line 200, column 20: " + [ v1.constructor.name ]);
          };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Halogen_Autocomplete_Component.component(Control_Monad_Aff.monadEffAff)(conf))([ "Hello", "Wello", "Yellow", "Darkness", "My old friend" ])(v);
  }));
  exports["conf"] = conf;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
