...
(function(exports) {
  ...
  var showReason = function (v) {
      if (v instanceof CuzEscape) {
          return "CuzEscape";
      };
      if (v instanceof CuzBlur) {
          return "CuzBlur";
      };
      if (v instanceof CuzNoMatches) {
          return "CuzNoMatches";
      };
      if (v instanceof CuzSelect) {
          return "CuzSelect";
      };
      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 52, column 14 - line 58, column 1: " + [ v.constructor.name ]);
  };
      ...
      return function (itemText) {
          return function (index) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $34.index = new Data_Maybe.Just(index);
                  $34.statusText = Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(itemText)(Data_Array.index(state.items)(index)));
                  return $34;
              }))(function () {
  ...
  var close = function (reason) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Debug_Trace.traceA(Debug_Trace.warn())(Halogen_Query_HalogenM.applicativeHalogenM)(showReason(reason)))(function () {
          return Control_Monad.whenM(Halogen_Query_HalogenM.monadHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              $37.index = Data_Maybe.Nothing.value;
              $37.open = false;
              return $37;
          }));
      });
  };
  var className = function ($99) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($99));
  };
      ...
      return function (v) {
              ...
              var mkSelection = function (ix) {
                  return function (item) {
                      return Halogen_HTML_Elements.li([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input(ItemClick.create(item))), Halogen_HTML_Properties_ARIA.selected((function () {
                          var $41 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(ix))(state.index);
                          if ($41) {
                              return "true";
                          };
                          return "false";
                      })()) ])([ Data_Bifunctor.bimap(Halogen_HTML_Core.bifunctorHTML)(Data_Void.absurd)(function ($100) {
                          return Data_Void.absurd(Data_Newtype.un(Data_Const.newtypeConst)(Data_Const.Const)($100));
                      })(v.itemDisplay(item)) ]);
                  };
              };
          ...
          var $$eval = function (v1) {
              ...
              if (v1 instanceof Input) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          var $51 = Data_Array["null"](Data_Array.filter(v.itemFilter(v1.value0))(v2.items));
                          if ($51) {
              ...
              if (v1 instanceof ItemClick) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(DOM_Event_MouseEvent.button(v1.value1) === 0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.mouseEventToEvent(v1.value1))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $56 = {};
                          for (var $57 in v2) {
                          ...
                          $56.inputText = v.itemText(v1.value0);
                          return $56;
                      }))(function () {
                          return close(CuzSelect.value);
                      });
                  })))(function () {
              ...
              if (v1 instanceof Select) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $62.inputText = v.itemText(v1.value0);
                      return $62;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value1);
                  });
              ...
              if (v1 instanceof Previous) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 166, column 8 - line 171, column 18: " + [ v2.index.constructor.name ]);
                  });
              };
              ...
              if (v1 instanceof Open) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $81.open = true;
                      $81.index = new Data_Maybe.Just(0);
                      return $81;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1.value0);
                  });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v1.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(displayedItems)(function (v4) {
                                  ...
                                  throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 192, column 12 - line 194, column 30: " + [ v5.constructor.name ]);
                              });
                          });
                      });
                  };
              ...
              throw new Error("Failed pattern match at Halogen.Autocomplete.Component line 142, column 12 - line 204, column 20: " + [ v1.constructor.name ]);
          };
